...
fig, ax = plt.subplots(figsize=(2.5, 2.5))
ax.plot(variable_parameters_values[1:-1], 0.35/variable_parameters_values[1:-1], linestyle="dashed", color="#7a7a7a", alpha=0.5)
ax.text(8e+1, 5e-3, r"$\mathcal{O}(\varepsilon^{-1})$", color="#7a7a7a")
ax.plot(variable_parameters_values[1:-1], 0.45/variable_parameters_values[1:-1]**(0.5), linestyle="dashed", color="#7a7a7a", alpha=0.5)
