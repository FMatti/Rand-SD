...
\todo{clean up messy notation with $n_v$}
...
\begin{proof}
    ...
    \end{equation}
    The latter follows from \reflem{lem:4-nystromchebyshev-parameter-nystrom}. Finally, the choices of $N_{\widetilde{n}_v}$ and $N_{n_{\mtx{\Omega}}}$ follow from \refthm{thm:4-nystromchebyshev-trace-correction} and \reflem{lem:4-nystromchebyshev-parameter-nystrom}.
\end{proof}
