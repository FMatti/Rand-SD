...
\begin{tikzpicture}
    ...
    \node[anchor=west] at (1.2, -0.22) {\footnotesize \texttt{> \input{pro-re-state.tex}}};
    \node[anchor=west] at (0.9, -0.65) {\small Learn more about Pro-Re at \url{https://github.com/FMatti/Pro-Re}.};
\end{tikzpicture}
\end{center}
