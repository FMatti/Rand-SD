...
other. Hence, it is sufficient to find coarse estimates of \refequ{equ:1-introduction-def-spectral-density}.
...
The three methods we will study in this thesis are based on \cite{lin2017randomized}.
