...
%the Girard-Hutchinson trace estimator with standard Gaussian random vectors
...
%\begin{equation}
%    \vct{\psi}_j^{\top} ((t - i\sigma)\mtx{I}_n - \mtx{A})^{-1} \vct{\psi}_j% &\approx \vct{e}_1^{\top} ((t - i\sigma)\mtx{I}_n - \mtx{H}_k)^{-1} \vct{e}_1 \notag \\
...
apply. We plot the results in \reffig{fig:5-experiments-haydock-convergence-nv} and
