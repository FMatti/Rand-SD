...
$[-1, 1]$ \cite{chen2021slq}, Erdos992\footnote{\url{https://sparse.tamu.edu/Pajek/Erdos992}},
an $6100 \times 6100$ matrix which representing the collaboration network of the
Hungarian mathematician P\'al Erd\H{o}s from \cite{chen2021slq}, and
GOE, a matrix $\mtx{A} = (\mtx{G} + \mtx{G}^{\top})/\sqrt{2}$ with standard
normal $G \in \mathbb{R}^{1000 \times 1000}$ from the Gaussian Orthogonal Ensemble. All these
