...
\begin{proof}
    ...
    %    + \sqrt{\frac{8}{\pi}} \frac{e^{\frac{c^2}{2}}}{c \sigma^2}  (1 + c \sigma)^{-m} && \text{(\refthm{thm:3-nystrom-frobenius-norm} and \reflem{lem:2-chebyshev-error})} \notag \\
    %    %&\leq \gamma^2(1 + r) \int_{-1}^{1} \sum_{i=r+1}^{n} (g_{\sigma}(t - \lambda_{(i)}) + 2\rho) \mathrm{d}t
    %    %+ \sqrt{\frac{8}{\pi}} \frac{e^{\frac{c^2}{2}}}{c \sigma^2}  (1 + c \sigma)^{-m} && \text{(\textcolor{red}{TODO})} \notag \\
