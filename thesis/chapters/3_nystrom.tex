...
\begin{table}[ht]
    ...
    and finally to the fast squaring algorithm \refalg{alg:3-alg:3-nystrom-chebyshev-exponentiation} as \enquote{squaring}.
...
\todo{insert table or plot to justify this claim}
