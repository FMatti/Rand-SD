...
\begin{figure}[ht]
    ...
    at certain values of \gls{spectral-parameter}.
...
\begin{theorem}{$L^1$-error of Nystr\"om-Chebyshev method with shift}{3-nystrom-nystrom-method}
    ...
    \begin{equation}
        ...
        \leq 4 \gamma^2(1 + r) (\varepsilon + 2 \rho (n-r))
...
\begin{proof}
    ...
    \begin{equation}
        \lVert \widehat{\underline{\phi}}_{\sigma}^{(m)} - \underline{\phi}_{\sigma}^{(m)} \rVert _1
