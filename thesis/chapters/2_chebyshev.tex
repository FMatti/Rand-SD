...
However, in order to retrieve the \glsfirst{smooth-spectral-density}
of the original matrix $\mtx{A}$, one has to be slightly careful:
Let us call $\bar{\phi}$ the spectral density of $\bar{\mtx{A}}$. From \refequ{equ:1-introduction-def-spectral-density}
