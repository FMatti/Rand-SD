...
\todo{Why trace estimation / interpolation}

\todo{\gls{num-evaluation-points}}
...
\todo{Discuss Chebyshev interpolation in general}
...
The coefficients $\{\mu_l(t)\}_{l=0}^m$ in \refequ{equ:2-chebyshev-chebyshev-expansion}
