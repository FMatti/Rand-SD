\begin{tikzpicture}
    ...
    \begin{scope}[shift={(0, 5)}]
        ...
        \node[anchor=west] at (2.2, -1.35) {None};
        
        \node[anchor=west] at (0.0, -1.85) {Trace};
        \node[anchor=west] at (2.2, -1.85) {Hutchinson};
        
        \draw (2.15, -0.15) to (2.15, -2.05);
    \end{scope}
    ...
    \begin{scope}[shift={(7, 5)}]
        ...
        \node[anchor=west] at (0.0, -0.35) {Origin};
        \node[anchor=west] at (2.2, -0.35) {\cite{lin2017randomized} Lin et. al. (2016)};
    ...
    % Expansion based
    \draw[rounded corners, line width=2, color=darkblue] (-0.5, 1.55) rectangle (14, -8.75);
    \node[fill=white] at (6.75, 1.55) {\bfseries \textcolor{darkblue}{Expansion based}};
    ...
    \begin{scope}[shift={(3.5, 0.5)}]
        ...
        \node[anchor=west] at (0.0, -0.35) {Origin};
        \node[anchor=west] at (2.2, -0.35) {\cite{silver1994kpm} Silver/Röder (1994)};
    ...
    \begin{scope}[shift={(0, -2.8)}]
        ...
        \node[anchor=west] at (0.0, -0.85) {Smoothing};
        \node[anchor=west] at (2.2, -0.85) {Gaussian};
