...
\newglossaryentry{spectral-parameter}%
{%
  name={$t$},%
...
\newglossaryentry{num-hutchinson-queries}
{%
  name={$n_{\Psi}$},%
...
\newglossaryentry{spectral-transformation}
{%
  name={$\tau$},%
...
\newglossaryentry{filter-tolerance}
{%
  name={$\eta$},%
...
\newglossaryentry{threshold-factor}
{%
  name={$\zeta$},%
...
\newglossaryentry{short-circuit-threshold}
{%
  name={$\kappa$},%
  description={non-zero check threshold},%
  first={non-zero check threshold $\kappa$},%
  firstplural={non-zero check threshold $\kappa$},%
  text={$\kappa$},%
  plural={$\kappa$}%
}
