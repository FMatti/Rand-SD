...
\begin{frame}{Delta-Gauss-Chebyshev (ingredients)}
    ...
    \begin{block}{Lemma: Parameter-dependent Hutchinson \cite{he2023parameter}}
        ...
        \begin{equation}
            \int_{a}^{b} \left| \Hutch_{n_{\Psi}}(\mtx{B}(t))  - \Tr(\mtx{B}(t)) \right| \mathrm{d}t \leq C_{\Psi} \frac{1}{\sqrt{n_{\Psi}}} \int_{a}^{b} \lVert \mtx{B}(t) \rVert _F \mathrm{d}t.
        \end{equation}
    \end{block}
\end{frame}
...
\begin{frame}{Delta-Gauss-Chebyshev (error guarantee)}
    \begin{block}{Theorem: Delta-Gauss-Chebyshev}
        ...
        \begin{equation}
            ...
            \leq \underbrace{\frac{C_1}{\sigma^2} (1 + C_2 \sigma)^{-m} \left( 1 + 2 C_{\Psi} \frac{n}{\sqrt{n_{\Psi}}} \right)}_{\text{interpolation error and bias}} + \underbrace{C_{\Psi} \frac{1}{\sqrt{n_{\Psi}}}}_{\text{trace estimation}}.
        \end{equation}
    \end{block}
    \begin{itemize}
